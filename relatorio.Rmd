...
# Gráficos Vacinas e Hospital Marieta
Row
-----------------------------------------------------------------------
...
bps20 <- dadosCorona %>%
    ...
    ggtitle("Boxplot Com Observações por Semana de 2020") +
    xlab("")
...
bps20 <- dadosCorona %>%
    ...
    ggtitle("Boxplot Com Observações por Semana de 2021") +
    xlab("")
...
bps20 <- dadosCorona %>%
    ...
    ggtitle("Boxplot Com Observações por Mês de 2020") +
    xlab("")
...
bps20 <- dadosCorona %>%
    ...
    ggtitle("Boxplot Com Observações por Mês de 2021") +
    xlab("")
